 ...
 * @returns {Promise} Promise dengan HTML content
 * 
 * Purpose: Mengambil HTML component dari server dengan error handling
 */
 ...
 * ================================================================
 * Purpose: Inisialisasi dan kontrol YouTube video sebagai background
...
function initBannerVideo() {
   ...
   * Purpose: Membuat player instance setelah API siap
   */
   ...
   * Purpose: Memulai video dan setup responsive sizing
   */
   ...
   * Purpose: Melakukan loop manual ketika video selesai
   */
  ...
  /**
   * Set YouTube Size
   * Purpose: Menjaga aspect ratio 16:9 responsif di semua ukuran layar
   */
 ...
 * THEME SWITCHER
 * ================================================================
 * Purpose: Toggle antara light mode dan dark mode dengan persistence
 ...
 * Update Theme UI
 * 
 * @param {Boolean} isLight - Status light mode
 * 
 * Purpose: Update icon theme switcher sesuai mode aktif
 */
...
function updateLogoFilter(isLight) {
  // Reserved untuk implementasi filter logo jika diperlukan
}

/* ================================================================
 * BOOTSTRAP DROPDOWNS
 * ================================================================
 * Purpose: Inisialisasi dropdown component Bootstrap
 ...
 * ================================================================
 * Purpose: Animasi counting number saat element visible di viewport
...
function initCounter() {
   ...
   * @param {Number} target - Target number untuk counting
   * 
   * Purpose: Smooth animation dari 0 ke target number
   */
 ...
 * ================================================================
 * Purpose: Highlight link navigasi sesuai halaman aktif
 * Dependencies: None
 * ================================================================ */
 ...
 * SIDEBAR LOGIC
 * ================================================================
 * Purpose: Kontrol sidebar navigation dengan smooth transition
 * Dependencies: jQuery
 * ================================================================ */
 ...
 * Purpose: Sidebar khusus untuk content editing interface
 */
 ...
 * Purpose: Toggle dropdown menu dalam sidebar
 */
 ...
 * SEARCH BAR
 * ================================================================
 * Purpose: Kontrol search overlay dan search functionality
 ...
 * Purpose: Fetch dan filter hasil search dari index JSON
 */
 ...
 * SCROLL ANIMATION
 * ================================================================
 * Purpose: Trigger animasi element saat masuk viewport
 * Dependencies: IntersectionObserver API, data-animate attribute
 * ================================================================ */
