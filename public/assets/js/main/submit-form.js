...
async function getCsrfToken() {
    try {
        const response = await fetch('/api/middleware/csrf.php');
...
function initSubmitContact() {
    $('#contactForm').on('submit', async function (event) {
        ...
        try {
            const response = await fetch('/api/controllers/form-process.php', {
                method: 'POST',
                body: formData
            });
...
function initSubmitNewsletter() {
    $('#newsletterForm').on('submit', async function(event) {
        ...
        try {
            const response = await fetch('/api/controllers/newsletter-process.php', {
                method: 'POST',
                body: formData
            });
            const result = await response.json();
